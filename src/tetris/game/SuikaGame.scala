...
import tetris.game.SuikaGame._
import tetris.logic.{Point => GridPoint}

class SuikaGame extends GameBase {
...
object SuikaGame {
  ...
  val WidthCellInPixels: Double = 30 * TetrisLogic.DrawSizeFactor
  val HeightCellInPixels: Double = WidthCellInPixels

  def main(args:Array[String]): Unit = {
    PApplet.main("tetris.game.SuikaGame")
  }
